...
/**
 * Core type definitions for genomic vector analysis
 */
...
export const VectorMetricSchema = z.enum(['cosine', 'euclidean', 'hamming', 'manhattan', 'dot']);
export type VectorMetric = z.infer<typeof VectorMetricSchema>;

export const QuantizationSchema = z.enum(['none', 'scalar', 'product', 'binary']);
...
export interface VectorDatabaseConfig {
  ...
  useWasm?: boolean;        // Use Rust/WASM for performance
}
...
export const EmbeddingModelSchema = z.enum([
  ...
  'esm2',           // Protein sequences
  'protbert',       // Protein sequences
  'phenotype-bert', // Clinical phenotypes
  'custom'
]);
...
export interface EmbeddingConfig {
  ...
  dimensions?: number;
  kmerSize?: number;        // For k-mer model
  stride?: number;          // For sliding window
...
export interface PluginContext {
  db: any;  // VectorDatabase instance
...
// ============================================================================
// Reinforcement Learning Types (from ReinforcementLearning.ts)
// ============================================================================
...
// ============================================================================
// Transfer Learning Types (from TransferLearning.ts)
// ============================================================================
...
// ============================================================================
// Federated Learning Types (from FederatedLearning.ts)
// ============================================================================
...
// ============================================================================
// Meta-Learning Types (from MetaLearning.ts)
// ============================================================================
...
// ============================================================================
// Explainable AI Types (from ExplainableAI.ts)
// ============================================================================
...
// ============================================================================
// Continuous Learning Types (from ContinuousLearning.ts)
// ============================================================================
...
export const schemas = {
  VectorMetric: VectorMetricSchema,
