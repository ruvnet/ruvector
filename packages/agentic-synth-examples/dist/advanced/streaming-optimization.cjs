...
var streaming_optimization_exports = {};
__export(streaming_optimization_exports, {
  StreamingOptimization: () => StreamingOptimization,
  runStreamingOptimizationExample: () => runStreamingOptimizationExample
});
module.exports = __toCommonJS(streaming_optimization_exports);
...
`);
  ...
  async initializeGenerators(apiKeys) {
    ...
    for (const modelConfig of this.models) {
      ...
      try {
        generators[modelConfig.name] = new import_agentic_synth.AgenticSynth({
...
//# sourceMappingURL=streaming-optimization.cjs.map